    ...
    const securityHeaders = [
      {
        ...
        value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob:; connect-src 'self' https://api.lmsys.org https://huggingface.co https://export.arxiv.org https://api.github.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self';",
      },
