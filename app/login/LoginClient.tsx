      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-[360px] animate-slide-up">
          ...
          <div className="relative mb-3 group">
            <button
              disabled
              className="flex w-full items-center gap-4 rounded-2xl border border-border bg-surface/60 px-5 py-3.5 text-sm font-medium text-text/40 shadow-sm cursor-not-allowed"
            >
              <svg className="h-5 w-5 shrink-0 opacity-40" viewBox="0 0 24 24">
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center rounded-2xl bg-black/60 opacity-0 transition-opacity group-hover:opacity-100">
              <span className="text-xs font-medium text-white">Option en construction</span>
            </div>
          </div>
          ...
          <div className="relative group">
            <button
              ...
              className="flex w-full items-center gap-4 rounded-2xl border border-border bg-surface/60 px-5 py-3.5 text-sm font-medium text-text/40 shadow-sm cursor-not-allowed"
            >
              <svg className="h-5 w-5 shrink-0 fill-current opacity-40" viewBox="0 0 24 24">
